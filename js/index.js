...
const displayLevelWord = (words) => {
 ...
 <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
            <h2 class="font-bold text-2xl">${word.word ? word : "শব্দের অর্থ পাওয়া যায়নি।"}</h2>
            <p class="font-semibold">sfsdf</p>
            <div class="text-2xl font-medium font-bangla">${word.meaning ? word.meaning : "শব্দের অর্থ পাওয়া যায়নি।"} / ${word.pronunciation ? word.pronunciation : "শব্দের অর্থ পাওয়া যায়নি।"}</div>
